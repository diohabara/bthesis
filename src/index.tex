...
\chapter{Method}\label{chapter:method}
  ...
  \section{Synthesis Process}\label{section:synthesisProcess}
    ...
    \begin{figure}[htbp]
      ...
      \begin{mathpar}
        \dfrac
          {\mathtt{\Gamma, E \vdash t : string \quad \Gamma, E \vdash hole :  \epsilon_{open} \to \epsilon_{read} \to \epsilon_{close} \quad x_n \in FV(t_{i \in 1 \cdots n-1})}}
          {\mathtt{t\ hole\ x_n \to [x_n \mapsto fread(t) : string]}}
          \left(\textrm{S-READ}\right) \and
        \dfrac
          {\mathtt{\Gamma, E \vdash t : int \quad \Gamma, E \vdash hole : string, \epsilon_{open} \to \epsilon_{write} \to \epsilon_{close}}}
          {\mathtt{t\ hole \to fwrite(stdout, t)}}
          \left(\textrm{S-INTWRITE}\right) \and
        \dfrac
          {\mathtt{\Gamma, E \vdash t : string \quad \Gamma, E \vdash hole : string, \epsilon_{open} \to \epsilon_{write} \to \epsilon_{close}}}
