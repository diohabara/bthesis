  ...
  \section{Synthesis Process}\label{section:synthesisProcess}
    ...
    \begin{figure}[htbp]
      ...
      \begin{mathpar}
        % bool
        \dfrac
          {\mathtt{E \vdash hole : \tau_{bool}}}
          {\mathtt{hole \longrightarrow boolean}}
          \left(\textrm{S-HOLEBOOL}\right) \and
        % int
        \dfrac
          {\mathtt{E \vdash hole : \tau_{integer}}}
          {\mathtt{hole \longrightarrow integer}}
          \left(\textrm{S-HOLEINT}\right) \and
        % string
        \dfrac
          {\mathtt{E \vdash hole : \tau_{string}}}
          {\mathtt{hole \longrightarrow string}}
          \left(\textrm{S-HOLESTRING}\right) \and
        % I/O
        \dfrac
        ...
        \dfrac
          ...
          {\mathtt{t\ hole \longrightarrow fwrite(t_1)}}
